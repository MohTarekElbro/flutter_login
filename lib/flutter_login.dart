...
class FlutterLogin extends StatefulWidget {
  ...
  static String? defaultPhoneValidator(String? value) {
...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  Widget build(BuildContext context) {
    ...
    final cardTopPosition = loginTheme.cardTopPosition ?? 185;
    final headerHeight = cardTopPosition - headerMargin;
    final userValidator =
        widget.userValidator ?? FlutterLogin.defaultEmailValidator;
    final phoneValidator =
        widget.phoneValidator ?? FlutterLogin.defaultEmailValidator;
