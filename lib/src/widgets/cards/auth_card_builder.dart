...
class AuthCard extends StatefulWidget {
  ...
  final VoidCallback? onPhoneSubmitCompleted;
...
class AuthCardState extends State<AuthCard> with TickerProviderStateMixin {
  ...
  // static const int _phoneNumber = 1;
    ...
    switch (index) {
      case _loginPageIndex:
        return _buildLoadingAnimator(
          ...
          child: _LoginCard(
            key: _loginCardKey,
            hasPhone: auth.onPhoneLogin != null && auth.onLogin != null,
            userType: widget.userType,
            hasOtpSignIn: widget.hasOtpSignIn,
            hasEmailSignIn: widget.hasEmailSignIn,
            ...
            // onSwitchPhoneNumber: () => _changeCard(_phoneNumber),
